...
//    }
    ...
    public ResponseEntity<Article> delete(@PathVariable Long id){
        ...
        return (target != null) ? ResponseEntity.status(HttpStatus.NO_CONTENT).build():
                ResponseEntity.status(HttpStatus.BAD_REQUEST).build();
    }
